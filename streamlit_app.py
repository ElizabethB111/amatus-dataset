...
if page == "Overview":
    ...
    with st.expander("What is AMATUS? Click to learn more."):
        st.markdown(
        """
- **AMATUS** stands for *Arithmetic Performance, Mathematics Anxiety and Attitudes in Primary School Teachers and University Students*. [Click here for study link](https://osf.io/gszpb/files/osfstorage).
...
- **AMATUS study contributors**: Krzysztof Cipora, Maristella Lunardon, Nicolas Masson, Carrie Georges, Hans-Christoph Nuerk, Christina Artemenko.
    ...
    st.image("decorations/math-anxiety.jpeg", width=1400)
    ...
    st.markdown(
        ...
        - Since most students reported low math learning anxiety (see Psychological Scores), these findings suggest that students may experience more anxiety than they report.
        """
    )
...
#------------------------------#
    ...
    st.write("Note: hover over a dot to see math self-concept score associated with anxiety & performance.")
...
#--------------------------------#
    ...
    st.markdown(
        "Explore how German university students in the study scored across various measures, including math anxiety and test-related self-concepts."
    )
