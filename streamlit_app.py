...
# Enhanced chart labels in Anxiety Triggers
...
# Student Profiles layout placeholder
elif page == "Student Profiles":
    st.header("Clustered Student Profiles")
    st.write("This page will show KMeans-based profiles of student anxiety patterns. Coming soon!")
